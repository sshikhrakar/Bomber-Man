...
(function () {
  ...
  function GameWorld() {
    ...
    this.gameToMainMenu = scorebar.children[0];
    this.scoreBoard = scorebar.children[2];
    this.scoreDiv = scorebar.children[3];
    ...
    this.endToMainMenu = endScreenButtons.children[0];
    this.endToGame = endScreenButtons.children[1];
    ...
    var initClickEvents = function() {
      ...
      that.gameToMainMenu.onclick = function() {
        clearInterval(that.mainGameLooper);
        that.htmlElement.innerHTML = "";
        that.homeScreen.style.opacity = 1;
        that.homeScreen.style.display = 'block';
        that.gameScreen.style.display = 'none';
      };

      that.endToMainMenu.onclick = function() {
        that.htmlElement.innerHTML = "";
        that.homeScreen.style.opacity = 1;
        that.homeScreen.style.display = 'block';
